...
1. Installez et démarrez l'intégration sans renseigner d'adresse IP.
...
6. Allumez la TV et acceptez la demande d'association webOS lors de la première connexion.
